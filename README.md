...
![Platform](https://img.shields.io/badge/platform-Any%20Browser-green)
![Size](https://img.shields.io/badge/size-~154KB-lightgrey)
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Try%20it%20now-brightgreen)](https://renishcm.github.io/Aiostics-Project-Manager/Aiostics_Project_Manager.html)
...
## Cloud Backup Without a Backend

The app saves automatically in your browser's local storage. For persistent
backup across devices:

1. Click **Save As** in the dashboard
...
| A or F | Add file to focused folder |
| S | Add section or folder |
| E | Expand all |
| M | Toggle minimap |
| Ctrl + S | Save |
| Ctrl + Z | Undo |
...
| Escape | Close form or clear focus |

Press **⌨️ Shortcuts** in the tab bar for the full reference at any time.
...
- ❌ Commercial use, resale, or SaaS deployment requires a commercial license

For commercial licensing: **Renish.CM@outlook.com**
...
**https://github.com/RenishCM/Aiostics-Project-Manager**

Copies from other sources should be verified before use.
...
**Renish C M**  
Renish.CM@outlook.com

For bug reports, feature requests, and commercial licensing enquiries.
